                                    ...
                                    (function ($, window, document, undefined) {
                                        ...
                                        GlassCase.prototype = {
                                            ...
                                            preloadImages: function () {
                                                ...
                                                // for drag and drop code starts 
                                                
                                                
                                                // for drag and drop code ends 
                                                
                                                function myFunction() {
                                                    var x = document.getElementById("myTopnav");
                                                    if (x.className === "nav-menu-top-ul") {
                                                        x.className += "responsive";
                                                    } else {
                                                        x.className = "nav-menu-top-ul";
                                                    }
                                                }
                                                ...
                                                $('.cart-div').click(function () {
                                                    let ul = $('.cart-div ul');
                                                    if (ul.hasClass('cart-content')) {
                                                        $('.cart-div ul').removeClass('cart-content')
                                                    } else {
                                                        $('.cart-div ul').addClass('cart-content')
                                                    }
                                                    
                                                });
                                                
                                                $("#show-about").click(function(){
                                                    $("#about-foot").slideToggle();
                                                    $("#show-about .fa-chevron-up").toggle();
                                                    $("#show-about .fa-chevron-down").toggle();
                                                });
